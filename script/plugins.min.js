!(function (t, e) {
  ...
  var t = (function (P) {
      ...
      try {
        A.apply((e = G.call(u.childNodes)), u.childNodes),
          ...
          if (11 !== h && (a = ct.exec(t)))
            if ((o = a[1])) {
              ...
              if (
                ...
                return A.apply(i, e.getElementsByClassName(o)), i;
            }
          if (
            d.qsa &&
            !g[t + " "] &&
        ...
        if ((l = !T.isEmptyObject(e)) || !T.isEmptyObject(d))
          ...
          d))
            l ||
              ...
              f && A([t], !0),
              h.done(function () {
                for (n in (f || A([t]), _.remove(t, "fxshow"), d))
                  T.style(t, n, d[n]);
              })),
              (l = ye(f ? m[n] : 0, n, h)),
              n in m ||
            ...
            this._queueCallback(
              () => {
                (this._isTransitioning = !1),
                  ...
                  this._element.classList.add(It, St),
  ...
  (function (t) {
    var e = (function (n, d, s) {
      ...
      function h(t, e) {
        (e = O(t, e)) &&
          t.setAttribute("class", (t[S]("class") || "").replace(e, " "));
      }
      function N(t, e) {
        var i;
        !ct && (i = n.picturefill || f.pf)
          ? (e && e.src && !t[S]("srcset") && t.setAttribute("srcset", e.src),
            ...
            _: function () {
              (B = s.now()),
                ...
                n.MutationObserver
                  ...
                  : (A[l]("DOMNodeInserted", r, !0),
                    A[l]("DOMAttrModified", r, !0),
                    setInterval(r, 999)),
                c("hashchange", r, !0),
                [
                  "focus",
            ...
            if (h[e] && !h[e]._lazyRace)
              if (!J || (p.prematureUnveil && p.prematureUnveil(h[e]))) k(h[e]);
                ...
                l ||
                  ((l =
                    !f.expand || f.expand < 1
                      ? 500 < A.clientHeight && 500 < A.clientWidth
                        ? 500
                        : 370
                      : f.expand),
                ...
                (w = c.bottom) >= s &&
                  ...
                  ((g && T < 3 && !r && (v < 3 || E < 4)) ||
                    (function (t, e) {
                      ...
                      for (
                        y -= e, w += e, b -= e, _ += e;
                        o && (n = n.offsetParent) && n != d.body && n != A;
                ...
                !n &&
                  ...
                  (m[0] ||
                    (!r &&
                      (w || _ || b || y || "auto" != h[e][S](f.sizesAttr)))) &&
                  (i = m[0] || h[e]);
          i && !n && k(i);
        }
      }
      ...
      function Tt(t) {
        var e,
          i = t[S](f.srcsetAttr);
        (e = f.customMedia[t[S]("data-media") || t[S]("media")]) &&
  ...
  (function (t, e) {
    ...
    (n.prototype.init = function () {
      ...
      (p.fn.vide = function (t, e) {
        ...
        return (
          this.each(function () {
            (i = p.data(this, s)) && i.destroy(),
              ((i = new n(this, t, e)).index = p.vide.lookup.push(i) - 1),
              p.data(this, s, i);
          }),
          this
        );
